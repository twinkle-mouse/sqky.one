...
import ArtPridefulPoem from "./assets/an-inverted-paracosm/prideful_poem.png";
...
<Picture src={ArtStaring} formats={["webp"]} alt="A crude-outlines illustration of a pair of overwhelmingly obscured eyes. There is a text below, 'Staring', that is in all-caps and shifts wildly." style="background-color: #000;" />
...
<figure style="max-width: 26rem; height: auto; margin-inline: auto; margin-block: 5rem;">
    ...
    <figcaption style="text-align: center; color: var(--strongColor);">
...
<Picture src={ArtChange} formats={["webp"]} alt="A crude-outlines illustration of a heart with a knife and a needle stabbed into it. There is a caption, in the same style, below the illustraion that reads: 'I've changed so much, I'm still the same'." style="background-color: #000;" />
